...
export const officialSources: SourceRecord[] = [
  ...
  {
    id: "parkland-homepage",
    name: "Parkland School District homepage",
    url: "https://www.parklandsd.org/",
    localPath: "data/raw/program/parkland-homepage.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "parkland-high-school-profile",
    name: "Parkland High School Profile PDF 2025-2026",
    url: "https://www.parklandsd.org/fs/resource-manager/view/fc98f66c-6aed-4adb-bfa6-f242c0aa609d",
    localPath: "data/raw/program/parkland-high-school-profile.pdf",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "parkland-late-activity-bus",
    name: "Parkland Late Activity Bus page",
    url: "https://www.parklandsd.org/departments/transportation/late-activity-bus",
    localPath: "data/raw/program/parkland-late-activity-bus.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "parkland-special-education",
    name: "Parkland Special Education page",
    url: "https://www.parklandsd.org/departments/student-services/special-education",
    localPath: "data/raw/program/parkland-special-education.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "parkland-gifted-education",
    name: "Parkland Gifted Education page",
    url: "https://www.parklandsd.org/departments/student-services/gifted-education",
    localPath: "data/raw/program/parkland-gifted-education.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "parkland-esl-program",
    name: "Parkland ESL Program page",
    url: "https://www.parklandsd.org/departments/office-of-teaching-and-learning/esl-program",
    localPath: "data/raw/program/parkland-esl-program.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "parkland-student-services",
    name: "Parkland Special Education & Student Services page",
    url: "https://www.parklandsd.org/departments/student-services",
    localPath: "data/raw/program/parkland-student-services.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "parkland-athletics",
    name: "Parkland Athletics page",
    url: "https://www.parklandsd.org/departments/athletics",
    localPath: "data/raw/program/parkland-athletics.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "parkland-arts",
    name: "Parkland Arts page",
    url: "https://www.parklandsd.org/departments/arts",
    localPath: "data/raw/program/parkland-arts.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "circle-of-seasons-homepage",
    name: "Circle of Seasons public homepage",
    url: "https://www.circleofseasons.org/",
    localPath: "data/raw/program/circle-of-seasons-homepage.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "pde-charter-schools",
    name: "PDE Charter Schools information page",
    url: "https://www.pa.gov/agencies/education/programs-and-services/instruction/elementary-and-secondary-education/charter-schools",
    localPath: "data/raw/program/pde-charter-schools.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
  {
    id: "pde-cyber-charter-schools",
    name: "PDE Cyber Charter Schools BEC",
    url: "https://www.pa.gov/agencies/education/resources/policies-acts-and-laws/basic-education-circulars-becs/purdons-statutes/cyber-charter-schools",
    localPath: "data/raw/program/pde-cyber-charter-schools.html",
    category: "program",
    schoolYear: "2025-2026",
    retrievedAt: RETRIEVED_AT,
  },
